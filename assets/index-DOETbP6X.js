...
`&&(a+=1),n.push(r),t.push(n),n=[],r=``):r+=o}return n.push(r),t.push(n),t.filter(e=>e.some(e=>e.trim()))}function v(e){let t=new Map;for(let n of e){if(!n||typeof n.message!=`string`)continue;let e=y(n.date),r=n.message.trim();!e||!r||t.set(e,r)}return t}function y(e){if(!e)return null;let t=String(e).trim();if(/^\d{4}-\d{2}-\d{2}$/.test(t))return t;let n=t.match(/^(\d{1,2})[\/\-.](\d{1,2})[\/\-.](\d{2,4})$/);if(!n)return null;let r=n[1].padStart(2,`0`),i=n[2].padStart(2,`0`);return`${n[3].length===2?`20${n[3]}`:n[3]}-${i}-${r}`}var b=`No wisdom message available for this date.`;function x(e){let t={selectedDate:i(),displayDate:i(),messages:new Map,favorites:j(),isLoading:!0,isDark:localStorage.getItem(`aka-theme`)===`dark`};e.innerHTML=S();let n=C(e);N(t.isDark),w(n,t),E(n,t),f().then(e=>{t.messages=e}).catch(()=>F(n,`Could not load messages. Showing empty state.`)).finally(()=>{t.isLoading=!1,E(n,t)})}function S(){return`
  ...
  `}function C(e){return{root:e,dateLine:e.querySelector(`.date-line`),messageText:e.querySelector(`.message-text`),calendarGrid:e.querySelector(`.calendar-grid`),weekdayRow:e.querySelector(`.weekday-row`),monthTitle:e.querySelector(`.month-title`),yearInput:e.querySelector(`.year-input`),prevMonth:e.querySelector(`.prev-month`),nextMonth:e.querySelector(`.next-month`),prevYear:e.querySelector(`.prev-year`),nextYear:e.querySelector(`.next-year`),todayButton:e.querySelector(`.today-button`),randomButton:e.querySelector(`.random-button`),favoriteButton:e.querySelector(`.favorite-button`),copyButton:e.querySelector(`.copy-button`),shareButton:e.querySelector(`.share-button`),themeToggle:e.querySelector(`.theme-toggle`),toast:e.querySelector(`.toast`)}}function w(e,t){e.prevMonth.addEventListener(`click`,()=>T(e,t,s(t.selectedDate,-1))),e.nextMonth.addEventListener(`click`,()=>T(e,t,s(t.selectedDate,1))),e.prevYear.addEventListener(`click`,()=>T(e,t,c(t.selectedDate,-1))),e.nextYear.addEventListener(`click`,()=>T(e,t,c(t.selectedDate,1))),e.todayButton.addEventListener(`click`,()=>T(e,t,i())),e.yearInput.addEventListener(`change`,()=>{let n=Number(e.yearInput.value);if(!Number.isInteger(n)||n<1900||n>2200){F(e,`Please enter a year between 1900 and 2200.`),e.yearInput.value=t.selectedDate.getFullYear();return}T(e,t,o(n,t.selectedDate.getMonth(),t.selectedDate.getDate()))}),e.randomButton.addEventListener(`click`,()=>{let n=[...t.messages.keys()];if(!n.length){F(e,`No messages available yet.`);return}let[r,i,a]=n[Math.floor(Math.random()*n.length)].split(`-`).map(Number);T(e,t,new Date(r,i-1,a))}),e.favoriteButton.addEventListener(`click`,()=>{let n=r(t.selectedDate);t.favorites.has(n)?(t.favorites.delete(n),F(e,`Removed from favorites.`)):(t.favorites.add(n),F(e,`Added to favorites.`)),M(t.favorites),E(e,t)}),e.copyButton.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(A(t)),F(e,`Wisdom copied.`)}catch{F(e,`Copy is not available on this device.`)}}),e.shareButton.addEventListener(`click`,async()=>{let n=A(t);try{navigator.share?await navigator.share({title:`Anant Ki Aur`,text:n}):(await navigator.clipboard.writeText(n),F(e,`Sharing not available. Wisdom copied instead.`))}catch{F(e,`Sharing was cancelled.`)}}),e.themeToggle.addEventListener(`click`,()=>{t.isDark=!t.isDark,localStorage.setItem(`aka-theme`,t.isDark?`dark`:`light`),N(t.isDark),E(e,t)})}function T(e,t,n){t.selectedDate=n,t.displayDate=n,E(e,t,!0)}function E(n,i,a=!1){let o=r(i.selectedDate),s=i.messages.get(o)||b;n.root.classList.toggle(`is-loading`,i.isLoading),n.root.classList.toggle(`is-animating`,a),n.dateLine.textContent=t.format(i.selectedDate),n.messageText.textContent=i.isLoading?``:s,D(n.messageText,s),n.monthTitle.textContent=e.format(i.displayDate),n.yearInput.value=i.selectedDate.getFullYear();let c=i.favorites.has(o);n.favoriteButton.textContent=c?`♥`:`♡`,n.favoriteButton.setAttribute(`aria-pressed`,String(c)),n.favoriteButton.setAttribute(`aria-label`,c?`Remove from favorites`:`Add to favorites`),n.themeToggle.textContent=i.isDark?`☀`:`☾`,O(n),k(n,i),a&&window.setTimeout(()=>n.root.classList.remove(`is-animating`),180)}function D(e,t){let n=t.trim().length;e.classList.remove(`message-short`,`message-medium`,`message-long`,`message-very-long`),n<=120?e.classList.add(`message-short`):n<=220?e.classList.add(`message-medium`):n<=340?e.classList.add(`message-long`):e.classList.add(`message-very-long`)}function O(e){e.weekdayRow.children.length||(e.weekdayRow.innerHTML=n.map(e=>`<span>${e}</span>`).join(``))}function k(e,n){let a=r(i()),o=r(n.selectedDate),s=l(n.displayDate);e.calendarGrid.innerHTML=s.map(e=>{if(!e)return`<span class="calendar-empty" aria-hidden="true"></span>`;let i=r(e),s=n.messages.has(i),c=i===o,l=i===a,u=n.favorites.has(i);return`
      ...
      `}).join(``),e.calendarGrid.querySelectorAll(`[data-date]`).forEach(t=>{t.addEventListener(`click`,()=>{let[r,i,a]=t.dataset.date.split(`-`).map(Number);T(e,n,new Date(r,i-1,a))})})}function A(e){let n=r(e.selectedDate),i=e.messages.get(n)||b;return`${t.format(e.selectedDate)}\n\n${i}\n\nॐ तत् सत्\nAnant Ki Aur`}function j(){try{return new Set(JSON.parse(localStorage.getItem(`aka-favorites`)||`[]`))}catch{return new Set}}function M(e){localStorage.setItem(`aka-favorites`,JSON.stringify([...e]))}function N(e){document.documentElement.dataset.theme=e?`dark`:`light`}var P;function F(e,t){window.clearTimeout(P),e.toast.textContent=t,e.toast.classList.add(`visible`),P=window.setTimeout(()=>e.toast.classList.remove(`visible`),2200)}x(document.querySelector(`#app`)),`serviceWorker`in navigator&&window.addEventListener(`load`,async()=>{try{let e=await navigator.serviceWorker.register(`./sw.js`);e.update(),e.waiting&&e.waiting.postMessage({type:`SKIP_WAITING`})}catch(e){console.warn(`Service worker registration failed:`,e)}});